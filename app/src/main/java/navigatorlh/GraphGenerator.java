...
public class GraphGenerator {
    ...
    public void ajouterOSM(File fichier) throws IOException, JDOMException {
        ...
        for (String nameArret : name_ID.keySet()) {
            ...
            for (String idArret : name_ID.get(nameArret)) {
                ...
                // Find ClosesNodes
                List<NodeQuad> lstNodeQuad = quadTree.findClosestNodes(new Point(lonAr, latAr), 2);
    ...
    public void ajouterLIA(File liaStops, File liaStopsTime) throws FileNotFoundException {
        ...
        while (scanner.hasNext()) {
            ...
            List<NodeQuad> lstNodeQuad = quadTree.findClosestNodes(new Point(stopLon, stopLat), 2);
            for (NodeQuad nodeQuad : lstNodeQuad) {
                String idNode = nodeQuad.getData();
        ...
        while (scanner.hasNext()) {
            ...
            System.out.println("Lien creer entre " + previousNode.getAttribute("name") + " et "
    ...
    public static void main(String[] args) throws IOException, JDOMException {
        ...
        graphGenerator.ajouterOSM(osmDonnees);
        graphGenerator.ajouterLIA(liaStops, liaStopsTime);
        System.out.println(graphGenerator.name_ID.size());
