...
public final class NavigatorLH implements ActionListener {
    ...
    public void startAndLoadUI() {
        ...
        if (demFolder != null) {
            MemoryCachingHgtReaderTileSource tileSource = new MemoryCachingHgtReaderTileSource(
                    new DemFolderFS(demFolder), new DiffuseLightShadingAlgorithm(), AwtGraphicFactory.INSTANCE);
        ...
        frame.addWindowListener(new WindowAdapter() {
            ...
            public void windowOpened(WindowEvent e) {
                ...
                mapView.getModel().mapViewPosition.setCenter(new LatLong(49.5, 0.15));
    ...
    private static TileRendererLayer createTileRendererLayer(TileCache tileCache, MapDataStore mapDataStore,
            IMapViewPosition mapViewPosition, HillsRenderConfig hillsRenderConfig) {
